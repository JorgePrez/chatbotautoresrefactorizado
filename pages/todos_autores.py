    ...
    if st.session_state.new_chat_general:
        ...
        if prompt:
            ...
            with st.chat_message("assistant"):
                ...
                for chunk in run_general_chain(prompt, st.session_state.messages_general):
            ...
            if DynamoDatabase.getNameChat(st.session_state.chat_id_general, session, author) == "nuevo chat":
                DynamoDatabase.editName(st.session_state.chat_id_general, prompt, session, author)
                st.rerun()
    else:
