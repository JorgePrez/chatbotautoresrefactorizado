...
import base64
from config.model_iacatching import run_mises_chain, extract_citations, parse_s3_uri
...
st.markdown("""
    ...
    /*        
     div.st-key-chat_input_mises textarea[data-testid="stChatInputTextArea"] {
...
logo_url = "https://miu.ufm.edu/intranet/reportesai/img_chatbot/Mises-noblank.png"  # reemplaza con la URL real
